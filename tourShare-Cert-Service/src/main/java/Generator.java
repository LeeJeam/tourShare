...
public class Generator {
    ...
    private static String PARENT_PACKAGE="com.xmyy.cert";
    /**
    ...
    public static void main(String[] args) {
        ...
        strategy.setInclude(new String[]{"uc_member_cert"}); // 需要生成的表
        ...
        InjectionConfig cfg = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                //map.put("cfg.rpcService", 1);
                //map.put("cfg.restControllerStyle", 1);
                this.setMap(map);
            }
        };
        mpg.setCfg(cfg);
