...
public class SHA256 {
    ...
    protected static final Logger logger = LoggerFactory.getLogger(SHA256.class);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("sha256 base64: " + s1);
        System.out.println("sha256 hex: " + s2);
        ...
        System.out.println("sha256 with salt base64: " + s1);
        System.out.println("sha256 with salt hex: " + s2);
    }
}
