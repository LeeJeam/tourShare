...
public class SHA384 {
    ...
    protected static final Logger logger = LoggerFactory.getLogger(SHA384.class);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("sha384 base64: " + s1);
        System.out.println("sha384 hex: " + s2);
        ...
        System.out.println("sha384 with salt base64: " + s3);
        System.out.println("sha384 with salt hex: " + s4);
    }
}
