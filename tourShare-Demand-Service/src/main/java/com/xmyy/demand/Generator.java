...
public class Generator {
    ...
    private static String OUTPUTDIR="D://An";

    private static String AUTHOR="AnCheng";

    private static String PARENT_PACKAGE="com.xmyy.demand";
    /**
    ...
    public static void main(String[] args) {
        ...
        strategy.setInclude(new String[]{"dg_demand_order"}); // 需要生成的表
