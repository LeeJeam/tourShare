...
@ApiModel(value = "发商品入参")
public class ApiProductCustomSaveParam implements Serializable{
    ...
    @ApiModelProperty(value = "购买国家国际码")
    ...
    private List<ApiCustomSkuDto> sku;
    ...
    public List<ApiCustomSkuDto> getSku() {
        return sku;
    }

    public void setSku(List<ApiCustomSkuDto> sku) {
        this.sku = sku;
    }
