...
public class Generator {
    ...
    private static String PARENT_PACKAGE="com.xmyy.product";
    /**
    ...
    public static void main(String[] args) {
        ...
        strategy.setInclude(new String[]{"dg_tour_card1","dg_tour1","dg_tour_site1"}); // 需要生成的表
